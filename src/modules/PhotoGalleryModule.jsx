...
const horizontalImages = import.meta.glob(
  '../assets/images/cats/horizontal/*.jpg',
  {
    eager: true,
...
// 세로형 이미지 가져오기
const verticalImages = import.meta.glob(
  '../assets/images/cats/vertical/*.jpg',
  {
    eager: true,
...
// 가로형 이미지를 배열로 변환
const horizontalImageList = Object.entries(horizontalImages).map(
  ([path, module]) => ({
    src: module.default,
...
// 세로형 이미지를 배열로 변환
const verticalImageList = Object.entries(verticalImages).map(
  ([path, module]) => ({
    src: module.default,
